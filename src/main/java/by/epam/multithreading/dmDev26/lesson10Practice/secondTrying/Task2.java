...
public class Task2 {
    ...
    private static int findMaxParallel(int[] values, ExecutorService threadPool) throws ExecutionException, InterruptedException {
        return threadPool.submit(() -> IntStream.of(values)
                .parallel()
                .max()
